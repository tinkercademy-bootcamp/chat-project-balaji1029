...
sockaddr_in tt::chat::client::Client::create_server_address(const std::string& server_ip, int port) {
...
void tt::chat::client::Client::send_and_receive_message(int sock, const std::string& message) {
  using namespace tt::chat;
